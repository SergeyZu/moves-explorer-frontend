      ...
      <div className='about-me__content'>
        <div className='about-me__text-block'>
          ...
          <p className='about-me__text'>
            ...
            студенческой скамьи и по настоящее время компьютер - мой постоянный
            спутник и помощник. До недавнего времени я, как и большинство людей
            был всего лишь пользователем ПК. Но вот мне захотелось узнать, как
            тут все устроено изнутри. Так я оказался на курсе
